...
Similar to a garden of forking paths (see Figure \@ref(fig:gardenForkingPaths)), there are many decision points in a study, and different decisions can lead to drastically different results.\index{open science}
