...
You also can pre-register decision trees that allow flexibility for multiple approaches depending on the data.\index{open science}\index{pre-registration}
