...
Due to the replication crisis, there has been a movement toward open, transparent science in which researchers pre-register their methods, and share their data and analysis scripts.\index{open science}\index{replication}\index{replication!failure to replicate}
