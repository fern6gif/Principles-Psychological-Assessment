...
Clients and participants have the prerogative to make choices about whether to receive a procedure, so they need to know the benefit(s) and harm(s) of each procedure.\index{ethics}\index{Belmont report}\index{beneficence}
