...
Pre-registration helps to make more explicit what tests are confirmatory (based on a priori directional hypotheses) and which are exploratory.\index{open science}\index{pre-registration}
